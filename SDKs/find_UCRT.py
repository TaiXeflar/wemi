        ...
        if ucrt_root:
            ...
            for ucrt in ucrt_versions:
                ...
                self.add_rule([ModulesObject(
                    ...
                    deps=[],
                    conflicts=["UCRT"],
                    VARs={"UCRT_VERSION":   ucrt,
                          "UCRT_ROOT":      ucrt_root,
                          "UCRT_ARCH":      arch,},
                    ENVs={"UCRTVersion": "$UCRT_VERSION",
                    ...
                    PATH=["$root/bin/$UCRT_ARCH",
                          "$root/bin/$UCRT_VERSION/$UCRT_ARCH"],
                    INCLUDE=["$root/include/$UCRT_VERSION/ucrt",
                    ...
                    LIB=["$root/lib/$UCRT_VERSION/ucrt/$UCRT_ARCH",
