...
| CI Stats | Status |
| :-- | :-- |
| Modules Only, AIO | [![Modules AIO Install Test](https://github.com/TaiXeflar/wemi/actions/workflows/modules-only-aio.yml/badge.svg?branch=master)](https://github.com/TaiXeflar/wemi/actions/workflows/modules-only-aio.yml) |
